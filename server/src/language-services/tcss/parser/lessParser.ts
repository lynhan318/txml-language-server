...
export class LESSParser extends cssParser.Parser {
    ...
    if (this.accept(TokenType.Colon)) {
      ...
      if (node.setValue(this._parseDetachedRuleSet())) {
        ...
        return <nodes.VariableDeclaration>(
          this.finish(node, ParseError.VariableValueExpected, [], panic)
        );
      }
  ...
  public _parseRuleSetDeclaration(): nodes.Node | null {
    ...
    return (
      ...
      super._parseRuleSetDeclaration()
  ...
  public _parseMixinParameter(): nodes.Node | null {
    ...
    if (
      !node.setDefaultValue(this._parseDetachedRuleSet() || this._parseExpr(true)) &&
      !hasContent
    ) {
      return null;
    }
