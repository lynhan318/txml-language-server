...
export const cssData: CSSDataV1 = {
  ...
  properties: [
    ...
    },
    {
      ...
      syntax: 'normal | <length-percentage>',
      relevance: 50,
      browsers: ['E84', 'FF63', 'S12.1', 'C84', 'O70'],
