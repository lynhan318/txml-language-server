  ...
  private static scssModuleLoaders = [
    {
      ...
      references: [
        { name: 'Sass documentation', url: 'https://sass-lang.com/documentation/at-rules/use' },
      ],
      insertText: '@use $0;',
      insertTextFormat: InsertTextFormat.Snippet,
      kind: CompletionItemKind.Keyword,
    },
    {
      ...
      references: [
        { name: 'Sass documentation', url: 'https://sass-lang.com/documentation/at-rules/forward' },
      ],
  ...
  private static scssModuleBuiltIns = [
    {
      ...
      references: [
        { name: 'Sass documentation', url: 'https://sass-lang.com/documentation/modules/math' },
      ],
    },
    {
      label: 'sass:string',
      ...
      references: [
        { name: 'Sass documentation', url: 'https://sass-lang.com/documentation/modules/string' },
      ],
    },
    {
      label: 'sass:color',
      ...
      references: [
        { name: 'Sass documentation', url: 'https://sass-lang.com/documentation/modules/color' },
      ],
    },
    {
      label: 'sass:list',
      ...
      references: [
        { name: 'Sass documentation', url: 'https://sass-lang.com/documentation/modules/list' },
      ],
    },
    {
      label: 'sass:map',
      ...
      references: [
        { name: 'Sass documentation', url: 'https://sass-lang.com/documentation/modules/map' },
      ],
    },
    {
      label: 'sass:selector',
      ...
      references: [
        { name: 'Sass documentation', url: 'https://sass-lang.com/documentation/modules/selector' },
      ],
    },
    {
      label: 'sass:meta',
      ...
      references: [
        { name: 'Sass documentation', url: 'https://sass-lang.com/documentation/modules/meta' },
      ],
    },
  ];
  ...
  public getTermProposals(
    ...
    if (entry) {
      functions = functions.filter(
        (f) => !f.type || !entry.restrictions || entry.restrictions.indexOf(f.type) !== -1,
      );
    }
