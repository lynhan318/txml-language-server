...
export class HTMLCompletion {
  ...
  public async doComplete2(
    ...
    this.completionParticipants = [participant as ICompletionParticipant].concat(
  ...
  private doesSupportMarkdown(): boolean {
    if (!isDefined(this.supportsMarkdown)) {
      ...
      const documentationFormat = this.lsOptions.clientCapabilities.textDocument?.completion
